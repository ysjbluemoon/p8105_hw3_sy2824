...
<img src="p8015_hw3_sy2824_files/figure-markdown_github/unnamed-chunk-5-1.png" width="100%" /> From the plot, there's a tendency to show that the mean value of each response stays almost the same over year. Also, the response of `Very good` `Good` weigh the most in mean value of proportion. `Poor` and `Fair` share the least proportion in mean value of proportion.
...
<img src="p8015_hw3_sy2824_files/figure-markdown_github/unnamed-chunk-8-1.png" width="100%" />
...
<img src="p8015_hw3_sy2824_files/figure-markdown_github/unnamed-chunk-13-1.png" width="100%" />
