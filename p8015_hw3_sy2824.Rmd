...
```
From the plot, there's a tendency to show that the mean value of each response stays almost the same over year. Also, the response of `Very good` `Good` weigh the most in mean value of proportion. `Poor` and `Fair` share the least proportion in mean value of proportion. 
